...
class APC_64_40_9(APC):
    ...
    def _setup_device_and_transport_control(self):
        ...
        for index in range(8):
            self._device_bank_buttons.append(ButtonElement(is_momentary, MIDI_NOTE_TYPE, 0, 58 + index))
            self._device_bank_buttons[-1].name = bank_button_labels[index]
            ...
            self._device_param_controls.append(ringed_encoder)
        self._device = ShiftableDeviceComponent()
        self._device.name = 'Device_Component'
        self._device.set_bank_buttons(tuple(self._device_bank_buttons))
        self._device.set_shift_button(self._shift_button)
        self._device.set_parameter_controls(tuple(self._device_param_controls))
        self._device.set_on_off_button(self._device_bank_buttons[1])
        ...
        bank_button_translator.set_controls_to_translate(tuple(self._device_bank_buttons))
